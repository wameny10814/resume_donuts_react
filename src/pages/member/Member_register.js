                    ...
                    <div className="col">
                        ...
                        <div className="logincard d-flex">
                            <div className="inputblock">
                                <label htmlFor="" required>帳號</label>
                                <input type="text" name="account" />
                            </div>
                            <div className="inputblock" >
                                <label htmlFor="" required>密碼</label>
                                <input type={eye} name="psd" onChange={textingCat} onBlur={blurtexting} />
                            ...
                            <div className="inputblock ">
                                <label htmlFor="" required>密碼確認</label>
                                <input type={eye} name="psdchek" onChange={textingCat} onBlur={blurtexting} />
                                <div className="absolute">
                                    <img
                                        className="logineye"
                                        src={pic}
                            ...
                            <div className="inputblock">
                                <label htmlFor="" required>電子信箱</label>
